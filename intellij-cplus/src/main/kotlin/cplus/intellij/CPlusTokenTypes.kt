...
object CPlusTokenTypes {
    ...
    @JvmField val COMPTIME_KEYWORD = IElementType("CPLUS_COMPTIME_KEYWORD", CPlusLanguage)
    @JvmField val COMPTIME_BUILTIN = IElementType("CPLUS_COMPTIME_BUILTIN", CPlusLanguage)
    @JvmField val BUILTIN_MACRO = IElementType("CPLUS_BUILTIN_MACRO", CPlusLanguage)
    @JvmField val COMPTIME_VALUE = IElementType("CPLUS_COMPTIME_VALUE", CPlusLanguage)
    @JvmField val COMPTIME_PROPERTY = IElementType("CPLUS_COMPTIME_PROPERTY", CPlusLanguage)
